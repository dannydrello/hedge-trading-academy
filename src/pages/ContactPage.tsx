      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="p-6 sm:p-8 rounded-2xl bg-[#0e1017] border border-slate-800 space-y-6">
              <h3 className="text-xl font-bold text-white">Direct Communication Desks</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 rounded-xl bg-slate-950 border border-slate-800/80">
                  ...
                  <div>
                    <div className="text-xs font-mono uppercase text-slate-400">Email The Academy</div>
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-slate-950 border border-slate-800/80">
                  ...
                  <div>
                    <div className="text-xs font-mono uppercase text-slate-400">Operating Trading Hours</div>
                    <div className="text-sm font-semibold text-white mt-0.5">Mon – Fri: 07:00 – 21:00 (London / UTC)</div>
            ...
            {/* Global Hubs */}
            <div className="p-6 sm:p-8 rounded-2xl bg-[#0e1017] border border-slate-800 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2 text-xs font-mono text-slate-300">
                <div className="p-2.5 rounded-lg bg-slate-950 border border-slate-800">
                  <span className="text-blue-400 font-bold block">London Desk</span>
                  Canary Wharf, London, UK
                </div>
                <div className="p-2.5 rounded-lg bg-slate-950 border border-slate-800">
                  <span className="text-blue-400 font-bold block">Singapore Hub</span>
            ...
            {/* Social Links */}
            <div className="p-6 sm:p-8 rounded-2xl bg-[#0e1017] border border-slate-800 space-y-4">
              <h3 className="text-base font-bold text-white">Follow The Academy</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-10 rounded-2xl bg-[#0e1017] border border-slate-800 shadow-2xl">
              {submitted ? (
                <div className="py-12 text-center space-y-4 animate-in fade-in">
                  ...
                  <div className="pt-6">
                    <button
                      ...
                      className="px-5 py-2.5 rounded-lg bg-slate-900 border border-slate-800 text-xs font-semibold text-slate-300 hover:text-white"
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm tracking-wide transition shadow-[0_0_20px_rgba(37,99,235,0.4)] flex items-center justify-center gap-2 cursor-pointer"
                  >
