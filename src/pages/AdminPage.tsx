...
export const AdminPage: React.FC<AdminPageProps> = ({
  ...
  if (!isAdminLoggedIn) {
    return (
      <div className="py-20 bg-[#08090C] min-h-[85vh] flex items-center justify-center px-4">
        <div className="max-w-md w-full p-8 sm:p-10 rounded-2xl bg-[#0e1017] border border-slate-800 shadow-2xl space-y-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4 pt-2">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-3 bg-slate-950 border border-slate-800 rounded-lg text-sm text-white placeholder-slate-600 focus:outline-none focus:border-blue-500 transition font-mono"
                  autoFocus
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full py-3.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm tracking-wide transition shadow-[0_0_20px_rgba(37,99,235,0.4)] cursor-pointer"
            >
  ...
  return (
    <div className="py-10 lg:py-16 bg-[#08090C] min-h-screen text-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Notification Toast */}
        {notification && (
          <div className="fixed top-24 right-4 z-50 p-4 rounded-xl bg-emerald-950 border border-emerald-500 text-emerald-200 shadow-2xl flex items-center gap-3 animate-in fade-in slide-in-from-top-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-8 border-b border-slate-800">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="px-2.5 py-0.5 rounded text-[11px] font-mono uppercase bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                Admin Mode Active
              </span>
              <span className="text-xs text-slate-500 font-mono">•</span>
              <span className="text-xs text-slate-400 font-mono">Hedge Trading Academy CMS</span>
            </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-slate-900 border border-slate-800 text-xs font-semibold text-slate-300 hover:text-white hover:border-slate-700 transition"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-red-950/40 border border-red-900/60 text-xs font-semibold text-red-400 hover:bg-red-900/60 transition"
            >
        ...
        {/* Action / Create Bar */}
        {!isEditing && (
          <div className="my-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-2xl bg-[#0e1017] border border-slate-800">
            <div>
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold shadow-[0_0_20px_rgba(37,99,235,0.35)] transition cursor-pointer"
            >
        ...
        {/* 3. Post Editor Form */}
        {isEditing ? (
          <div className="my-6 rounded-2xl bg-[#0e1017] border border-slate-800 overflow-hidden shadow-2xl">
            {/* Editor Header */}
              ...
              <form onSubmit={handleSavePost} className="p-6 sm:p-8 space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  <div className="lg:col-span-2 space-y-2">
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-lg text-base font-bold text-white placeholder-slate-600 focus:outline-none focus:border-blue-500 transition"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-lg text-sm text-white focus:outline-none focus:border-blue-500 transition"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    required
                    className="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-lg text-sm text-white placeholder-slate-600 focus:outline-none focus:border-blue-500 transition"
                  />
                </div>
                ...
                <div className="space-y-3 p-5 rounded-xl bg-slate-950/70 border border-slate-800">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <label className="block text-xs font-mono uppercase tracking-wider text-slate-300 flex items-center gap-1.5">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <input
                      ...
                      className="flex-1 px-4 py-2.5 bg-slate-900 border border-slate-800 rounded-lg text-xs text-white placeholder-slate-600 font-mono focus:outline-none focus:border-blue-500"
                    />
                    <input
                      type="file"
                      ref={fileInputRef}
                  ...
                  <div className="pt-2">
                    <span className="text-[11px] font-mono text-slate-400 mr-2">Or select preset:</span>
                  ...
                  {/* Image Preview */}
                  {coverImage && (
                    <div className="mt-3 relative w-full h-44 rounded-lg overflow-hidden border border-slate-800 bg-slate-900">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    required
                    className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-lg text-sm text-slate-200 font-sans leading-relaxed placeholder-slate-600 focus:outline-none focus:border-blue-500 transition"
                  />
                </div>
                  ...
                  {additionalImages.length > 0 && (
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-3">
                      {additionalImages.map((imgUrl, i) => (
                        <div key={i} className="relative group rounded-lg overflow-hidden border border-slate-800 h-28 bg-slate-900">
                ...
                <div className="flex items-center justify-end gap-3 pt-6 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold shadow-[0_0_20px_rgba(37,99,235,0.4)] transition cursor-pointer"
                  >
                ...
                {additionalImages.length > 0 && (
                  <div className="grid grid-cols-2 gap-3 pt-4">
                    {additionalImages.map((img, i) => (
                      <img key={i} src={img} alt="Gallery" className="rounded-lg h-40 w-full object-cover border border-slate-800" />
                    ))}
                  </div>
                )}
          ...
          <div className="space-y-4">
            <div className="overflow-x-auto rounded-2xl border border-slate-800 bg-[#0e1017]">
                  ...
                  {posts.map((post) => (
                    <tr key={post.id} className="hover:bg-slate-900/50 transition">
                      ...
                      <td className="px-4 py-4">
                        <span className="px-2.5 py-1 rounded text-xs font-medium bg-slate-900 text-blue-400 border border-slate-800 whitespace-nowrap">
                          {post.category}
                        </span>
                      </td>
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="p-2 rounded-lg bg-slate-900 border border-slate-800 text-slate-300 hover:text-blue-400 hover:border-blue-500/40 transition"
                            title="Edit Blog"
                          >
                          ...
                          <button
                            ...
                            className="p-2 rounded-lg bg-slate-900 border border-slate-800 text-slate-400 hover:text-red-400 hover:border-red-500/40 transition"
                            title="Delete Blog"
                          >
